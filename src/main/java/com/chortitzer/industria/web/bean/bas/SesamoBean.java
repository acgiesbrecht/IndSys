...
import com.chortitzer.industria.web.domain.bas.DetalleSesamo;
...
public class SesamoBean implements Serializable {
    ...
    public List<DetalleSesamo> getSesamoList() {
        ...
        if (selectedEmpresa == null && getSelectedProducto() == null) {
            sesamoList = dao.getByDateRange(DetalleSesamo.class, "fechahora", fechaDesde, fechaHasta);
        } else if (selectedEmpresa == null && getSelectedProducto() != null) {
            sesamoList = dao.getViewByDateRangeAndProducto(DetalleSesamo.class, "fechahora", fechaDesde, fechaHasta, selectedProducto);
        } else if (selectedEmpresa != null && getSelectedProducto() == null) {
            sesamoList = dao.getViewByDateRangeAndEmpresa(DetalleSesamo.class, "fechahora", fechaDesde, fechaHasta, selectedEmpresa);
        } else if (selectedEmpresa != null && getSelectedProducto() != null) {
            sesamoList = dao.getViewByDateRangeAndEmpresaAndProducto(DetalleSesamo.class, "fechahora", fechaDesde, fechaHasta, selectedEmpresa, selectedProducto);
        }
        getTotalBruto();
        getTotalTara();
        getTotalNeto();
    ...
    public List<Tblproductos> getProductosSesamoList() {
        productosSesamoList = dao.getAllSesammoProductos();
